...
const userIdVAlidator=check('id').isMongoId().withMessage('Invalid Cat ID Format');
...
const EmailValidator=
 ...
 const passwordValidator=
        ...
        .isLength({min:3}).withMessage('Too Short Password')
        .custom((password,{req})=>{
...
const confirmPassword=
        ...
        .notEmpty().withMessage("consfirm password is required");
...
const profileImageValidator=
 ...
 const phoneValidator= 
        ...
        .isMobilePhone('ar-EG').withMessage('Enter Egypt Valid Phone Number ');
...
const updateUserPasswordValidator=
        ...
        .custom(async(password,{req})=>{
            ...
            const isTheUserPassword=await  bcrypt.compare(req.body.currentPassword,user.password);
...
exports.updateuserValidator=[userIdVAlidator,checkUserUpdate,
                             userNameValidator,phoneValidator,
                             roleValidaor,profileImageValidator,userValidatorMiddelWare];


exports.updateuserPasswordValidator=[userIdVAlidator,updateUserPasswordValidator,
                                     passwordValidator, userValidatorMiddelWare];
